...
// Mostrar la imagen "velanigga" si está presente en alguna compra
compras.forEach((compra) => {
    // Verificar si la compra tiene una imagen
    if (compra.imagen) {
        // Verificar si la imagen es "velanigga"
        if (compra.imagen === "images/velanigga.jpg") {
            // Asignar la ruta de la imagen al elemento de imagen
            $("#imagenCompra").attr("src", compra.imagen);
        }
    }
});
